    ...
    validateQuestion = (questionText) => {
        if(questionText.length === 0) {
            return {
                ...
                errorMsg: 'Please enter your petition!'
            }
    ...
    render() {
        ...
        return (
            <div className="new-poll-container">
                <center><img src="https://media4.giphy.com/media/26gsnIf5oRCFIw4q4/200.webp?cid=ecf05e475qd5gnhfn5is1jhve3tkpt8cmlunioyx2fsbpm6e&rid=200.webp" alt="protest" height="100px" width="100px" /></center><br />
                <div className="new-poll-content">
                    <Form onSubmit={this.handleSubmit} className="create-poll-form">
                        ...
                        <TextArea 
                            placeholder="Enter your problem to which petition has to be signed (Note:People will only be able to give suggestion"
                            style = {{ fontSize: '16px' }} 
                        ...
                        <FormItem className="poll-form-row">
                            <Button type="danger" onClick={this.addChoice} disabled={this.state.choices.length === MAX_CHOICES}>
                                <Icon type="plus" /> Add more choices
                            </Button>
                        </FormItem>
                        <FormItem className="poll-form-row">
                            <Col xs={24} sm={4}>
                        ...
                        <FormItem className="poll-form-row">
                            <Button type="danger" 
                                ...
                                className="create-poll-form-button">Create petition</Button>
                        </FormItem>
                    </Form>
                </div>    
            </div>
